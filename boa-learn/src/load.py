...
def load_nhanes(year):
    ...
    dem_path=f'https://wwwn.cdc.gov/Nchs/Nhanes/{year-1}-{year}/DEMO_F.XPT'
    gluc_path=f'https://wwwn.cdc.gov/Nchs/Nhanes/{year-1}-{year}/GLU_F.XPT'
    cbc_path=f'https://wwwn.cdc.gov/Nchs/Nhanes/{year-1}-{year}/CBC_F.XPT'
